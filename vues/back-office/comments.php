...
<html lang="fr">
  <head>
    ...
    <title>Commentaires Admin - Facebook-like</title>
  ...
  <body>
    <div class="admin-layout">
      <aside class="admin-sidebar">
        ...
        <nav class="admin-sidebar-nav">
          ...
          <a href="comments.php" class="admin-nav-item active"><i class="fa-solid fa-comments"></i> Commentaires</a>
      ...
      <main class="admin-main">
        ...
        <section>
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.2em;">
            <input id="comment-search" class="admin-search" type="text" placeholder="Rechercher un utilisateur, un post ou un commentaire..." style="max-width: 320px;" />
          </div>
          <div id="comments-loader" style="display:none; text-align:center; margin-bottom:1em;">
            <i class="fa fa-spinner fa-spin" style="font-size:1.7em; color: var(--color-primary);"></i>
          </div>
          <div style="overflow-x:auto;">
            <table id="comments-table" class="admin-table" style="width:100%; min-width:700px;">
              <thead>
                <tr>
                  <th>ID</th>
                  <th>Utilisateur</th>
          ...
          <div id="comments-pagination" class="admin-pagination"></div>
        </section>
        <section>
          <h2>Statistiques Commentaires</h2>
    ...
    <script src="../../assets/js/admin-comments.js"></script>
  </body>
</html> 